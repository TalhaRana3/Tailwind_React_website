  ...
  return (
    <div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
      ...
      <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
        <div className='space-y-5 text-sm txt-gray-700 dark:text-white'>
       ...
       <div className='flex justify-center gap-4 flex-wrap sm:justify-between pb-5'>
        <p className='text-sm text-gray-500'>Copyright 2025 © GreatStack - All Right Reserved.</p>
