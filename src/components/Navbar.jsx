...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    <div className="flex justify-between items-center px-4 sm:px-12 lg:px-4 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70">
      <img
      ...
      <div className=" flex items-center gap-2 sm:gap-4 ">
        ...
        <a
          href="#contact-us"
          className="text-sm max-sm:hidden bg-primary rounded-full text-white flex justify-center items-center center px-6 py-2 cursor-pointer hover:scale-103 transition-all  gap-2"
        >
